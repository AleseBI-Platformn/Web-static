    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 overflow-hidden">
        {currentView ? (
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white min-h-screen animate-fadeIn">
            ...
            <div className="bg-white/80 backdrop-blur-lg border-b border-gray-200/50 px-3 py-3 sm:px-4 sm:py-4 md:px-6 shadow-sm">
              <div className="flex flex-col space-y-3 sm:space-y-2 xl:flex-row xl:items-center xl:justify-between xl:space-y-0">
                ...
                <div className="flex items-center justify-between sm:justify-end space-x-2 sm:space-x-3 animate-slideInLeft">
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    <span className="text-xs text-gray-500 font-medium hidden sm:inline">
                      Última actualización
                    </span>
                    <div className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="inline-flex items-center px-2 sm:px-2.5 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border border-green-200">
                  ...
                  <button
                    ...
                    className="group inline-flex items-center px-2 sm:px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:from-gray-400 disabled:to-gray-500 shadow-md text-xs font-medium rounded-lg text-white transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 active:scale-95 disabled:cursor-not-allowed"
                  >
                    <RefreshCw className={`h-3.5 w-3.5 sm:mr-1.5 transition-transform duration-200 ${isRefreshing ? 'animate-spin' : 'group-hover:rotate-180'}`} />
                    <span className="hidden sm:inline ml-1.5">{isRefreshing ? 'Actualizando...' : 'Actualizar'}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          // Dashboard principal - RESPONSIVE OPTIMIZADO PARA TABLETS E IPAD
          <div className="max-w-7xl mx-auto h-full overflow-y-auto">
              ...
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="px-3 py-4 sm:px-4 sm:py-5 md:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0">
                    ...
                    <div className="sm:ml-4 md:ml-5 text-center sm:text-left">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-5 xl:grid-cols-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 sm:ml-4 md:ml-5 w-0 flex-1">
                        <dl>
                          ...
                          <dd className="text-sm sm:text-base md:text-lg font-medium text-gray-900">
                            Dashboard Activo
                          </dd>
                        </dl>
                      </div>
                ...
                <div className="bg-white overflow-hidden shadow rounded-lg">
                  <div className="p-3 sm:p-4 md:p-5">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <TrendingUp className="h-5 sm:h-6 w-5 sm:w-6 text-purple-600" />
                      </div>
                      <div className="ml-3 sm:ml-4 md:ml-5 w-0 flex-1">
                        <dl>
                          <dt className="text-xs sm:text-sm font-medium text-gray-500 truncate">
            ...
            <div className="px-3 py-4 sm:px-4 sm:py-5 md:px-6 md:py-6 lg:px-8">
              <div className="bg-white shadow rounded-lg">
                <div className="px-3 py-4 sm:px-4 sm:py-5 md:p-6">
                  <h3 className="text-base sm:text-lg md:text-xl leading-6 font-medium text-gray-900 mb-4">
                    Panel de Control
                  </h3>
                  <div className="text-center py-6 sm:py-8 md:py-12">
                    <BarChart3 className="mx-auto h-10 sm:h-12 md:h-16 w-10 sm:w-12 md:w-16 text-gray-400" />
                    <h3 className="mt-2 text-sm sm:text-base font-medium text-gray-900">
                      Analytics Dashboard
                    </h3>
                    <p className="mt-1 text-xs sm:text-sm text-gray-500 px-4 max-w-md mx-auto">

...
interface NavbarProps {
  ...
  onHomeClick?: () => void;
  currentView?: MenuItem | null;
}

const Navbar: React.FC<NavbarProps> = ({ onMenuClick, onHomeClick, currentView }) => {
    ...
    <nav className="bg-white shadow-lg border-b sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 xl:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center flex-1 justify-center mx-4" style={{ overflow: 'visible' }}>
            <div className="flex items-center space-x-1 xl:space-x-2 overflow-x-auto scrollbar-hide max-w-full" style={{ overflow: 'visible' }}>
              ...
              {onHomeClick && currentView && (
                <button
                  onClick={onHomeClick}
                  className="navbar-button flex items-center space-x-1 px-2 xl:px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200 flex-shrink-0"
          ...
          {/* Right side - Home Button, User Menu & Mobile Button */}
          <div className="flex items-center space-x-2 flex-shrink-0">
            {/* User Menu */}
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200 shadow-lg max-h-[calc(100vh-4rem)] overflow-y-auto">
            ...
            {onHomeClick && currentView && (
              <button
                onClick={onHomeClick}
                className="w-full flex items-center space-x-2 px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-200"
              >
